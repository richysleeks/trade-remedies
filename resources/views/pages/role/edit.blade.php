        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    <a href="{{ route("role.edit", $role->id) }}" class="kt-subheader__breadcrumbs-home">
            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="kt-portlet">
                        ...
                        <form novalidate="novalidate" role="form" class="form-horizontal" method="POST" action="{{ route('role.update', $role->id) }}">
                            {{csrf_field()}}  
                            {{method_field('PUT')}}  
